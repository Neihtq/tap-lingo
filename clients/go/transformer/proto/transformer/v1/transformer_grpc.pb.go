...
const (
	TransformerService_Transform_FullMethodName = "/transformer.v1.TransformerService/Transform"
)
...
func RegisterTransformerServiceServer(s grpc.ServiceRegistrar, srv TransformerServiceServer) {
	// If the following call panics, it indicates UnimplementedTransformerServiceServer was
...
var TransformerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "transformer.v1.TransformerService",
	...
	Metadata: "proto/transformer/v1/transformer.proto",
}
